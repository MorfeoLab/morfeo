...
export class FormElementComponent implements OnInit {
  @ViewChild('componentPlaceholder', {static: true, read: ViewContainerRef}) public componentPlaceholder: ViewContainerRef;
    ...
    if (this.isInput(this.component)) {
      ...
      if (this.isJsonLogic(this.component.disabled)) {
        this.conditional.registerJsonRule(
          ...
          this.externalData,
          (v) => {
            const valid = v.reduce((a,b) => { return !!a && !!b;});
      ...
      this.conditional.registerJsonRule(
        ...
        (v) => {
          ...
          if(!!this.formRef.controls[this.component.key + this.component.suffix]) {
            this.formRef.controls[this.component.key + this.component.suffix].setValue(v, {onlySelf: true, emitEvent: false});
