...
@Component({
  selector: 'mrf-object-list-selector-modal',
  templateUrl: './object-list-selector-modal.component.html',
  styleUrls: ['./object-list-selector-modal.component.scss']
})
export class ObjectListSelectorModalComponent implements OnInit, AfterViewInit {
  /**
  ...
  constructor(
    public dialogRef: MatDialogRef<ObjectListSelectorModalComponent>,
