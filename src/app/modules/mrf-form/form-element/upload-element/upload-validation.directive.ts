import {AfterViewInit, Directive, forwardRef, Input, OnInit} from '@angular/core';
import {NG_VALIDATORS, NgForm, NgModel, ValidationErrors, Validator} from '@angular/forms';
